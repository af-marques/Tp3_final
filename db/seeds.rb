...
Product.create(:name => %{Code}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/31GBgcA5PML._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{The Mythical Man Month and Other Essays on Software Engineering}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51WIpM70FEL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Programming in Haskell}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41rwtENNgBL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{A First Course in Database Systems}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/21LvRYu-YSL._SL500_AA240_.jpg", 
...
Product.create(:name => %{The C Programming Language (2nd Edition)}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51TGEPRTDNL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Algorithmic Problem Solving}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41k9iBLxsqL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Computer Science Illuminated}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51W-YaXNAVL._SL500_AA240_.jpg", 
...
Product.create(:name => %{The Annotated Turing}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51OId3bQb5L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Elements of Computing Systems}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51y65-nCd6L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Real World Haskell}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51I6dXmEFKL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		   :description => %{Code You Can Believe In}, 
		   :price => 20.97, 
		   :category_id => Category.find_by_name("Books").id )
Product.create(:name => %{The Ruby Programming Language}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51oDo%2BQKHJL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Programming Ruby 1.9}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51vFypbVAPL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Eloquent Ruby (Addison-Wesley Professional Ruby)}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41KtNo1H-DL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{The Ruby Programming Language eBook}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51c3tL7dShL._SL500_AA258_PIkin4,BottomRight,-30,22_AA280_SH20_OU02_.jpg", 
		   :description => %{The Ruby Programming Language is the authoritative guide to Ruby and provides
      comprehensive coverage of versions 1.8 and 1.9 of the language. It was written (and
      illustrated!) by an all-star team:David Flanagan, bestselling author of programming language
...
Product.create(:name => %{jQuery in Action, Second Edition}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41VTNwW9TWL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{jQuery Pocket Reference}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41TqXJJB2oL._SL500_AA240_.jpg", 
		   :description => %{Read Less, Learn More}, 
		   :price => 6.30, 
		   :category_id => Category.find_by_name("Books").id )
Product.create(:name => %{JQuery For Dummies (For Dummies (Computers))}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51jhzavPtOL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Olympus SZ-10 Digital Camera - Black 3.0 inch LCD}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41NflxbzxxL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Olympus SZ-30MR Digital Camera - Silver 3.0 inch LCD}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/418UPpkH6tL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Canon PowerShot SX220 HS Digital Camera - Grey 3.0}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/4103madSZ%2BL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Panasonic Lumix FS16 Digital Camera - Black 2.7 inch}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51sIW-4Z7fL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Nikon D3100 18-55vr Kit}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/515cImXYaxL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Nikon D3000 Digital SLR Camera}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41eP4KInalL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Nikon D5100 Digital SLR Camera}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41AP1FRW4YL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Nikon D7000 Body Only}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51QaUtKfHbL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Nikon D7000 18-105 VR Kit}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41p8fEXmnuL._SL500_AA280_.jpg", 
		   :description => %{The new Nikon D7000: Ready to fulfil your passion The D7000's increased ISO
      sensitivity (100-6400, extendable up to 25600) ensures exceptional detail with minimal noise
      when capturing fast moving subjects or in poor light situations, even without the flash Click
      here for a larger image The Nikon D7000 is a D-SLR that offers exceptional image quality,
...
Product.create(:name => %{Nikon D90 Body Only}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51QNs7A7r0L._SL500_AA280_.jpg", 
...
Product.create(:name => %{LG 42LK450U 42-inch Widescreen Full HD 1080p LCD TV}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41p1HESlZwL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Humax Freeview playback Digital TV Recorder PVR-9150T}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/31Ks%2Bsy1tcL._SL500_AA280_.jpg", 
...
Product.create(:name => %{My Book Essential WDBAAF0020HBK - Hard drive - 2 TB - external - Hi-Speed USB}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/31UkWrSrq8L._SL500_AA280_.jpg", 
...
Product.create(:name => %{Lenovo G570 15.6 inch Notebook (Core i5-2410M, RAM 6GB, HDD 640GB, DVDRW, Windows 7 Home
      Premium) - Black}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41-wWTzAeML._SL500_AA280_.jpg", 
...
Product.create(:name => %{New Apple Macbook Pro 13 inch Notebook (Intel Core i5 Dual Core 2.3GHz, 4GB RAM, 320GB
      HDD, Up to 7 hrs battery life) - Launched February 2011}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/419eHFlskkL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Network Fundamentals, CCNA Exploration Companion Guide Cisco Networking Academy
      Program}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51QjJK4I8XL._SL500_AA240_.jpg", 
...
Product.create(:name => %{The Pragmatic Programmer}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41HXiIojloL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Peopleware}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51MlUgcSICL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Code Complete}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51nWkLCu1SL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Introduction to Java Programming, Comprehensive}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41i7MxLPIaL._SL500_AA240_.jpg", 
...
Product.create(:name => %{C Pocket Reference}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41Sl1Tum67L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Modern Operating Systems}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/418WBniVP-L._SL500_AA240_.jpg", 
...
Product.create(:name => %{Absolute Beginner's Guide to C (Other Sams)}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51lg5JNal3L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{C. Answer Book (Prentice Hall Software)}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/416Te4p4YpL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Computer Organization and Design}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51HGo4MjkZL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Exploring Wonderland}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51HTa9sp-CL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Java for Everyone}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51a1AxprMNL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Pandora's Box}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/413-OHFRWKL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{The Alan Turing}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51Bace34YQL._SL500_AA240_.jpg", 
		   :description => %{'Ten essential books on technology' --New Statesman}, 
		   :price => 6.61, 
		   :category_id => Category.find_by_name("Books").id )
Product.create(:name => %{The Essential Turing}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/519P3W7LBNL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{The Man Who Knew Too Much}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41-I%2Bp%2BUiYL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Introduction to Algorithms}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41roHsC7F4L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Seven Languages in Seven Weeks}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51C%2BJGTYWbL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Learn You a Haskell for Great Good!}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41-CJxuUV%2BL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Purely Functional Data Structures}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41XlPaC%2BZqL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Programming In Scala 2nd Edition}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51w1YjEaT-L._SL500_AA240_.jpg", 
...
Product.create(:name => %{Agile Web Development with Rails Pragmatic Programmers}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51Pkt8UcdAL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Ruby on Rails 3 Tutorial}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51TEzGZ%2BggL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Beginning Ruby}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/512242IrWmL._SL500_AA240_.jpg", 
...
Product.create(:name => %{The Rails 3 Way (Addison-Wesley Professional Ruby)}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41CsLULhOfL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{The RSpec Book}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51tFzC0fFZL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Metaprogramming Ruby}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41ygBmdaIfL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Design Patterns in Ruby Addison-Wesley Professional Ruby}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51kExzC-67L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{JavaScript}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51WD-F3GobL._SL500_AA240_.jpg", 
		   :description => %{Activate Your Web Pages}, 
		   :price => 20.65, 
		   :category_id => Category.find_by_name("Books").id )
Product.create(:name => %{Python Essential Reference (4th Edition) eBook}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41wFtSK7t2L._SL500_AA258_PIkin4,BottomRight,-43,22_AA280_SH20_OU02_.jpg", 
...
Product.create(:name => %{Ruby Pocket Reference (Pocket Reference (O'Reilly)) eBook}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41izyC2aXYL._SL500_AA258_PIkin4,BottomRight,-50,22_AA280_SH20_OU02_.jpg", 
...
Product.create(:name => %{User Stories Applied}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51BzIIaznpL._SL500_AA258_PIkin4,BottomRight,-31,22_AA280_SH20_OU02_.jpg", 
...
Product.create(:name => %{The Ruby Way, Second Edition}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/413K6WbfbjL._SL500_AA258_PIkin4,BottomRight,-31,22_AA280_SH20_OU02_.jpg", 
...
Product.create(:name => %{HTML5 and CSS3}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51rGLcXiuNL._SL500_AA240_.jpg", 
...
Product.create(:name => %{jQuery Cookbook}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/513BcG%2BGZDL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		   :description => %{Solutions & Examples for jQuery Developers}, 
		   :price => 14.93, 
		   :category_id => Category.find_by_name("Books").id )
Product.create(:name => %{Introducing HTML 5 (Voices That Matter)}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/31eSqTFIaFL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Pro ASP.NET MVC 3 Framework 3rd Edition}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/515GwPEj8gL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{CSS}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41SwXc5CPUL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Stunning CSS3}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/417DebeFMkL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{JavaScript Pocket Reference Pocket Reference O'Reilly}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51zjJBw5OwL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{CSS Pocket Reference}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51ZOekO77hL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{HTML & XHTML Pocket Reference Pocket Reference O'Reilly}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51cv5koB8FL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		   :description => %{Quick, Comprehensive, Indispensible}, 
		   :price => 6.36, 
		   :category_id => Category.find_by_name("Books").id )
Product.create(:name => %{CSS Pocket Reference (Pocket Reference (O'Reilly))}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51h6SQFRsKL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		   :description => %{Visual Presentation for the Web}, 
		   :price => 5.14, 
		   :category_id => Category.find_by_name("Books").id )
Product.create(:name => %{JavaScript and Ajax For Dummies}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/510ajQUIM6L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{HTML, XHTML and CSS For Dummies For Dummies Computers}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51uuI%2BDdplL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{PHP and MySQL Web Development All-in-one Desk Reference For Dummies}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51HcVqDTAUL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{jQuery}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41xoUXdWINL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Olympus TRHLC-120 Traveller Hard Leather Case}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51ajRCcFnuL._SL500_AA280_.jpg", 
...
Product.create(:name => %{ABC Products Rechargeable Lithium-Ion Battery Li50b}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41HUR6i5aOL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Olympus TRHC-120 Traveller Hard Case}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51He98iFTGL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Ex-Pro Olympus Li-50b, Li50b, High Power Plus+ 925mAh 2}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41K4b6dBIVL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Waterproof & Light Weight Black Camera Case for Olympus}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51-CcLzzTJL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Ex-Pro Olympus Li-50B, Li50b Digital Camera Battery}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/418kdwLF6QL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Transcend 16GB SDHC Class 10 Memory Card}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41HhhTcP0bL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Canon DCC-1500 Soft Camera Case for PowerShot SX210 IS}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/411V6qUP5bL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Snug fit Black Waterproof Hard Camera Case for Canon}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/417dGDY9AYL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Lowepro Rezo 30 Digital Camera Pouch - Burnt Orange}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41cftvWID-L._SL500_AA280_.jpg", 
...
Product.create(:name => %{Anti-Shock Waterproof Double Protection Black Tough}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/310-D8jKiyL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Energizer CA5L Digital Camera Battery Equivalent to}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51AoXf1fdQL._SL500_AA280_.jpg", 
		   :description => %{Battery}, 
		   :price => 8.24, 
		   :category_id => Category.find_by_name("Electronics").id )
Product.create(:name => %{Ex-Pro Canon NB-5L NB5L, High Power Plus+ 2 Year}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41FFZfaG3GL._SL500_AA280_.jpg", 
		   :description => %{Ex-Pro replacement Li-ion Battery. Can be used as a replacement or additional
      battery. Our cell's are manufactured to the highest standard meeting or exceeding the orginal
      manufacturers specification and supplied with a 2 year RTB guarantee. Ex-Pro batteries are
      fully tested and built with lithium-Ion technology to ensure maximum Power and battery life.
...
Product.create(:name => %{Panasonic DMW-PSS13KK Leather Case for FS Series}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/31QFpza9%2BvL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Panasonic DMW-PSS13XEK Case for the Lumix FS and S}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41C8s2v0hvL._SL500_AA280_.jpg", 
...
Product.create(:name => %{SANDISK 8 GB Secure Digital SDHC Card - Frustration Free Packaging}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41Y-MhculiL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Panasonic Lumix DMW-PSS13 Genuine Camera Case}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41opyETc%2B6L._SL500_AA280_.jpg", 
...
Product.create(:name => %{Panasonic Genuine Leather Case for the Panasonic Lumix}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/21FsWN86qsL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Lowepro Altus 10 Small Camera Pouch ideal for Canon}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/31OB9WCovvL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Hama Starter Kit for Nikon D3100 Camera}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51VJ3-OqiqL._SL500_AA280_.jpg", 
...
Product.create(:name => %{AmazonBasics Wireless Remote Control for Nikon P7000}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41d48PfSqjL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Nikon D3100}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/515AXIU1M4L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Nikon D3100 Digital Field Guide}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/5190XR2yqaL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Lowepro Nova 160 AW All Weather Shoulder Bag for}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41SM8BGAjvL._SL500_AA280_.jpg", 
...
Product.create(:name => %{SquareTrade 3-Year Warranty Plus Accident Protection}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51HDv0OyieL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Gem Easy Access SLR Camera Case for Nikon D300S, D3000}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51BiMoxjwFL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Nikon D3000 For Dummies For Dummies Lifestyles Paperback}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51Ag2bt5H-L._SL500_AA240_.jpg", 
...
Product.create(:name => %{Lig0sh}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/31vJRLT3HFL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Nikon D3000}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51qNpGD49nL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Nikon D3000 Digital Field Guide}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51WVjhsF0iL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Nikon D5100 For Dummies (For Dummies (Computers))}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51ziwQCCFAL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Nikon D5100 Digital Field Guide}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51uXiXwWvxL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Nikon AF-S DX NIKKOR 55-300mm f/4.5-5.6G VR Lens}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41FV5XfqEvL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Nikon Li-on batteri EN-EL14, VFB10602}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/31YoucP-1uL._SL500_AA280_.jpg", 
		   :description => %{Opladeligt Li-on batteri EN-EL}, 
		   :price => 37.29, 
		   :category_id => Category.find_by_name("Electronics").id )
Product.create(:name => %{Nikon Li-ion battery EN-EL15, VFB10702}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41JPFRh%2Bc2L._SL500_AA280_.jpg", 
...
Product.create(:name => %{Nikon 18-200mm F3.5-5.6G IF-ED AF-S VR II DX Lens}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41%2BCbW6EgnL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Neewer Vertical Battery Grip for Nikon D7000 Digital}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/31KwDWnRvRL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Nikon AF-S DX 16-85MM}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/516wPz9GtEL._SL500_AA280_.jpg", 
...
Product.create(:name => %{David Busch's Nikon D7000 Guide to Digital SLR Photography}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51WThdhpkIL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Nikon AF-S DX 35mm f1.8G}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41CEOa4NmTL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Nikon D7000 For Dummies For Dummies Lifestyles Paperback}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51HX6wf5O3L._SL500_AA240_.jpg", 
...
Product.create(:name => %{Hoya 67mm Pro-1 Digital UV Screw in Filter}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/417WByDBYtL._SL500_AA280_.jpg", 
		   :description => %{Hoya UV Pro 1 Digital 67}, 
		   :price => 27.16, 
		   :category_id => Category.find_by_name("Electronics").id )
Product.create(:name => %{Nikon D7000 Digital Field Guide}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51I5zhrCdAL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Nikon ML-L3 Remote Control}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41TpK4N5N6L._SL500_AA280_.jpg", 
...
Product.create(:name => %{Nikon 50mm F1.8D AF Nikkor Lens}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51CnjgPJ%2BjL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Nikon EN-EL3e Rechargeable Battery}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/31V3ADN9TBL._SL500_AA280_.jpg", 
		   :description => %{Nikon is a precision optical company with worldwide manufacturing, research and
      marketing capabilities. The Nikon name is equated with extraordinary photographic performance,
      innovation, precision and optical quality.}, 
		   :price => 25.00, 
...
Product.create(:name => %{Nikon D90 For Dummies}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51k%2BPHE1BEL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{The Nikon D90 Companion}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51iLztBblTL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Designer Habitat Wall Tilt Bracket for 32 - 55 inch LCD}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/31qcsd1wUGL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Premier AV HF0042 Plasma & LCD Glass Stand upto 50" or}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41zf5lMepGL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Plasma & LCD Glass Stand Up to 42" - Black Glass}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41B61DQOgTL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Designer Habitat -Plasma/LED/LCD}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/31UCPZOyzbL._SL500_AA280_.jpg", 
...
Product.create(:name => %{SquareTrade 5-Year TV Warranty Plus Accident Protection}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51DzfCD4NIL._SL500_AA280_.jpg", 
		   :description => %{Please note: Your Warranty Contract will be delivered via email within 24 hours of
      purchase and not mailed to you. If you don&#x2019;t receive it, please contact 0800 433
      4789 . The purchase of this extended warranty is not a requirement of your Amazon.co.uk
      purchase. These SquareTrade extended warranties are sold and administered by SquareTrade
...
Product.create(:name => %{Strand Gold Plated Scart to Scart Lead 1.5m}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/4176ZS96W9L._SL500_AA280_.jpg", 
...
Product.create(:name => %{Wired--up v1.3A HDMI to HDMI Gold Plated Connectors}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/415yUGy2SfL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Panasonic TX-L32C3B 32-inch Widescreen HD Ready LCD TV}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41V%2BPJNreqL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Humax Foxsat HDR 500GB Freesat HD Satellite Receiver}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/31O7GIBQtxL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Humax PVR9300T 320GB Twin Tuner, PVR}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/31G6QYbVFPL._SL500_AA280_.jpg", 
...
Product.create(:name => %{WD My Book Essential 3.0 2 TB External Hard Drive (USB 3.0/2.0)}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/31L5klk5oeL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Western Digital My Book Mac Edition 2TB USB 2.0 External Hard Drive}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/21RkVgrWujL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Western Digital TV Live HD Media Player}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/417mw6e7UvL._SL500_AA280_.jpg", 
...
Product.create(:name => %{DVD Minus (16X speed) Inkjet printable spindle 50}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/31QE9vcK2%2BL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Western Digital 2TB SATA 6Gbps Power Saving Internal Hard Drive OEM - Caviar Green}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41wqVYC86UL._SL500_AA280_.jpg", 
...
Product.create(:name => %{WD My Book Live Personal Cloud Storage 2 TB Network Attached Storage}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/31GV10OL%2BlL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Belkin Neoprene Sleeve For Notebooks Up To 15.6-Inch, Chocolate/tourmaline}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/21AfBQwqUPL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Belkin F8N204EA Providence Street Case for Notebooks Up to 15.6 inch - Black}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/21LCfss4crL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Microsoft Office 2010 Home and Student, 3 Users (PC)}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41cgP%2BUBgvL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Microsoft Office 2010 Home and Student, 1 User [Product Key Card] (PC)}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41FufTm6Z3L._SL500_AA280_.jpg", 
		   :description => %{Microsoft Office Home and Student 2010 --licensed for noncommercial use, includes:
      Microsoft Excel 2010 Microsoft PowerPoint 2010 Microsoft Word 2010 Microsoft OneNote 2010 With
      Microsoft Office Home and Student 2010, you and your kids can create great schoolwork and home
      projects from multi-page bibliographies to multimedia presentations. Capture ideas and set
...
Product.create(:name => %{Belkin Neoprene Sleeve For Notebooks Up To 15.6-Inch, Jet/cabernet}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/2193aSqPMTL._SL500_AA280_.jpg", 
		   :description => %{Designed to fit and complement your notebook, these sleeves offer plush-line fabric
      notebook compartments to keep your notebook secure and free from scratching. Its unique,
      asymmetrical zipper design makes it ideal for easy access to your notebook from the top or the
      side. You can use the sleeve inside another bag for easy carrying or on its own for on-site
...
Product.create(:name => %{13.3" Inch Apple Macbook Soft Carry Case Sleeve - Black}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/31e69CbHTsL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Office for Mac 2011, Home and Student Edition (1 User, 1Mac)}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41PN1CYA0RL._SL500_AA280_.jpg", 
...
Product.create(:name => %{LArobe Black Addict MacBook 13.3 Inch - Black + Wasabi}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/21sof3YJ9jL._SL500_AA280_.jpg", 
...
Product.create(:name => %{AppleCare Protection Plan for 13 inch MacBook/MacBook Air/MacBook Pro}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/31JK6tN8T9L._SL500_AA280_.jpg", 
...
Product.create(:name => %{Routing Protocols and Concepts, CCNA Exploration Companion Guide Cisco Systems Networking
      Academy Program}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/31XnU8U91QL._SL500_AA240_.jpg", 
...
Product.create(:name => %{LAN Switching and Wireless, CCNA Exploration Companion Guide Cisco Systems Networking
      Academy Program}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51Tv4lpJKIL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Accessing the WAN, CCNA Exploration Companion Guide Cisco Systems Networking Academy
      Program}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51vPa9rjRuL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Network Fundamentals, CCNA Exploration Labs and Study Guide Cisco Networking Academy
      Program}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41nIUvEljsL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Modern Systems Analysis and Design}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41OB1vIDVUL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Clean Code}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41znMZniZ1L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Refactoring}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51T4YZ3HieL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Programming Pearls (ACM Press)}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41ETT7KQRRL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Design patterns }, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51Q-RLSadrL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Slack }, 
		   :image_url => "http://ecx.images-amazon.com/images/I/513Jes0CBKL._SL500_AA240_.jpg", 
		   :description => %{"Slack" is a work on business management.}, 
		   :price => 7.49, 
		   :category_id => Category.find_by_name("Books").id )
Product.create(:name => %{Management 3.0}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51dtvyU2b4L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Head First Design Patterns}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51Q6l%2BMyLgL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Java How to Program}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/61HcHvW4JIL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Software Engineering}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/517enbDKK7L._SL500_AA240_.jpg", 
...
Product.create(:name => %{UML Distilled}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51N90Q8iwnL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Head First Java}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51a1RPCmv7L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Java Pocket Guide (Pocket Guides)}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/5176Hqjno2L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
      ...
      practicing developers.}, 
		   ...
		   :category_id => Category.find_by_name("Books").id )
Product.create(:name => %{C++ Pocket Reference}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41tfvZgFIiL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Python Pocket Reference Pocket Reference O'Reilly}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51O2eIVhIOL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		   :description => %{Python in Your Pocket}, 
		   :price => 7.15, 
		   :category_id => Category.find_by_name("Books").id )
Product.create(:name => %{bash Pocket Reference Pocket Reference O'Reilly}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51QvoPPPMxL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Artificial Intelligence}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51PfWyaZxkL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Operating Systems Design and Implementation}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/21Np4yEIzwL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Concepts, Techniques, and Models of Computer Programming}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51JGRqYyy%2BL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Computer Networks}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/516PKzMgc7L._SL500_AA240_.jpg", 
...
Product.create(:name => %{C++}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51IWmNxF2tL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{C Programming in Easy Steps}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41DZbYjkZ2L._SL500_AA240_.jpg", 
...
Product.create(:name => %{C for Dummies}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/516VkSVE0ZL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{HTML, XHTML, and CSS}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51ID6MKVMOL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{C. Puzzle Book}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/413Y85XXXWL._SL500_AA240_.jpg", 
...
Product.create(:name => %{C Programming}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41srLM7zoEL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Expert C Programming}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41186C2QEZL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Advanced Programming in the UNIX Environment Addison-Wesley Professional Computing}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51LYZX2quyL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Computer Architecture}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/515a1tC7sOL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Speech and Language Processing}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51KDxLZyd5L._SL500_AA240_.jpg", 
...
Product.create(:name => %{Professional Issues in Information Technology}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/410V6ZCZ8DL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Systems Analysis and Design with UML}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/61TuLDldmmL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Studying Programming (Palgrave Study Guides)}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51TJQ9MPDYL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Maths Credit 2011 SQA Past Papers (Standard Grade)}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51AhNTc66DL._SL500_AA240_.jpg", 
		   :description => %{###############################################################################################################################################################################################################################################################}, 
		   :price => 7.19, 
		   :category_id => Category.find_by_name("Books").id )
Product.create(:name => %{Staedtler Triplus Colour 323 SB20 Fibre Tip Pens In Desktop Box - 20 Assorted
      Colours}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51LMuSwq2KL._SL500_AA280_.jpg", 
...
Product.create(:name => %{Learning to Program with Alice (w/CD-ROM)}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/519nAd3oCXL._SL500_AA240_.jpg", 
...
Product.create(:name => %{The Essentials of Computer Organization and Architecture}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/515Q48TJQAL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Discrete Mathematics and Its Applications with MathZone}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/31u2ffsdpiL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Schaum's Outline of Probability and Statistics, 3/E Schaum's Outline Series}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51k12tjHPWL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Object-Oriented Analysis and Design}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41C3SZ5DAXL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Human Computer Interaction}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/617J74145FL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Applying UML and Patterns}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51aukquzeFL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Organizational Behaviour Plus Companion Website Access Card}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/41VlJoGwzOL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Internet and World Wide Web}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/61b%2BS2P3vKL._SL500_AA240_.jpg", 
...
Product.create(:name => %{Enigma}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51Xvl-BY5-L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Colossus}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/412KLgk9qgL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Codebreakers}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51A8YA2X0DL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
...
Product.create(:name => %{Station X}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51x9a4jPm2L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		   :description => %{}, 
		   :price => 2.81, 
		   :category_id => Category.find_by_name("Books").id )
Product.create(:name => %{Secret Days}, 
		   :image_url => "http://ecx.images-amazon.com/images/I/51%2BxVp2OMuL._SL500_AA240_.jpg", 
...
Relation.delete_all
Relation.create(:product_id => Product.find_by_name(%{Code}).id, 
			  :assoc_id => Product.find_by_name(%{Computer Science Illuminated}).id )
Relation.create(:product_id => Product.find_by_name(%{Code}).id, 
			  :assoc_id => Product.find_by_name(%{The C Programming Language (2nd Edition)}).id )
Relation.create(:product_id => Product.find_by_name(%{Code}).id, 
			  :assoc_id => Product.find_by_name(%{Algorithmic Problem Solving}).id )
Relation.create(:product_id => Product.find_by_name(%{The Mythical Man Month and Other Essays on Software Engineering}).id, 
			  :assoc_id => Product.find_by_name(%{The Pragmatic Programmer}).id )
Relation.create(:product_id => Product.find_by_name(%{The Mythical Man Month and Other Essays on Software Engineering}).id, 
			  :assoc_id => Product.find_by_name(%{Programming in Haskell}).id )
Relation.create(:product_id => Product.find_by_name(%{The Mythical Man Month and Other Essays on Software Engineering}).id, 
			  :assoc_id => Product.find_by_name(%{A First Course in Database Systems}).id )
Relation.create(:product_id => Product.find_by_name(%{Programming in Haskell}).id, 
			  :assoc_id => Product.find_by_name(%{A First Course in Database Systems}).id )
Relation.create(:product_id => Product.find_by_name(%{Programming in Haskell}).id, 
			  :assoc_id => Product.find_by_name(%{Real World Haskell}).id )
Relation.create(:product_id => Product.find_by_name(%{Programming in Haskell}).id, 
			  :assoc_id => Product.find_by_name(%{Algorithmic Problem Solving}).id )
Relation.create(:product_id => Product.find_by_name(%{A First Course in Database Systems}).id, 
			  :assoc_id => Product.find_by_name(%{Programming in Haskell}).id )
Relation.create(:product_id => Product.find_by_name(%{A First Course in Database Systems}).id, 
			  :assoc_id => Product.find_by_name(%{Algorithmic Problem Solving}).id )
Relation.create(:product_id => Product.find_by_name(%{The C Programming Language (2nd Edition)}).id, 
			  :assoc_id => Product.find_by_name(%{C Pocket Reference}).id )
Relation.create(:product_id => Product.find_by_name(%{The C Programming Language (2nd Edition)}).id, 
			  :assoc_id => Product.find_by_name(%{Absolute Beginner's Guide to C (Other Sams)}).id )
Relation.create(:product_id => Product.find_by_name(%{The C Programming Language (2nd Edition)}).id, 
			  :assoc_id => Product.find_by_name(%{C. Answer Book (Prentice Hall Software)}).id )
Relation.create(:product_id => Product.find_by_name(%{Algorithmic Problem Solving}).id, 
			  :assoc_id => Product.find_by_name(%{Programming in Haskell}).id )
Relation.create(:product_id => Product.find_by_name(%{Algorithmic Problem Solving}).id, 
			  :assoc_id => Product.find_by_name(%{A First Course in Database Systems}).id )
Relation.create(:product_id => Product.find_by_name(%{Algorithmic Problem Solving}).id, 
			  :assoc_id => Product.find_by_name(%{The C Programming Language (2nd Edition)}).id )
Relation.create(:product_id => Product.find_by_name(%{Computer Science Illuminated}).id, 
			  :assoc_id => Product.find_by_name(%{Java for Everyone}).id )
Relation.create(:product_id => Product.find_by_name(%{The Annotated Turing}).id, 
			  :assoc_id => Product.find_by_name(%{The Essential Turing}).id )
Relation.create(:product_id => Product.find_by_name(%{Elements of Computing Systems}).id, 
			  :assoc_id => Product.find_by_name(%{The C Programming Language (2nd Edition)}).id )
Relation.create(:product_id => Product.find_by_name(%{Elements of Computing Systems}).id, 
			  :assoc_id => Product.find_by_name(%{Introduction to Algorithms}).id )
Relation.create(:product_id => Product.find_by_name(%{Elements of Computing Systems}).id, 
			  :assoc_id => Product.find_by_name(%{Computer Science Illuminated}).id )
Relation.create(:product_id => Product.find_by_name(%{Real World Haskell}).id, 
			  :assoc_id => Product.find_by_name(%{Programming in Haskell}).id )
Relation.create(:product_id => Product.find_by_name(%{Real World Haskell}).id, 
			  :assoc_id => Product.find_by_name(%{Purely Functional Data Structures}).id )
Relation.create(:product_id => Product.find_by_name(%{Real World Haskell}).id, 
			  :assoc_id => Product.find_by_name(%{Programming In Scala 2nd Edition}).id )
Relation.create(:product_id => Product.find_by_name(%{The Ruby Programming Language}).id, 
			  :assoc_id => Product.find_by_name(%{The Rails 3 Way (Addison-Wesley Professional Ruby)}).id )
Relation.create(:product_id => Product.find_by_name(%{Programming Ruby 1.9}).id, 
			  :assoc_id => Product.find_by_name(%{The Rails 3 Way (Addison-Wesley Professional Ruby)}).id )
Relation.create(:product_id => Product.find_by_name(%{Programming Ruby 1.9}).id, 
			  :assoc_id => Product.find_by_name(%{The Ruby Programming Language}).id )
Relation.create(:product_id => Product.find_by_name(%{Eloquent Ruby (Addison-Wesley Professional Ruby)}).id, 
			  :assoc_id => Product.find_by_name(%{The Rails 3 Way (Addison-Wesley Professional Ruby)}).id )
Relation.create(:product_id => Product.find_by_name(%{jQuery in Action, Second Edition}).id, 
			  :assoc_id => Product.find_by_name(%{jQuery Cookbook}).id )
Relation.create(:product_id => Product.find_by_name(%{jQuery in Action, Second Edition}).id, 
			  :assoc_id => Product.find_by_name(%{Introducing HTML 5 (Voices That Matter)}).id )
Relation.create(:product_id => Product.find_by_name(%{jQuery in Action, Second Edition}).id, 
			  :assoc_id => Product.find_by_name(%{Pro ASP.NET MVC 3 Framework 3rd Edition}).id )
Relation.create(:product_id => Product.find_by_name(%{jQuery Pocket Reference}).id, 
			  :assoc_id => Product.find_by_name(%{jQuery Cookbook}).id )
Relation.create(:product_id => Product.find_by_name(%{JQuery For Dummies (For Dummies (Computers))}).id, 
			  :assoc_id => Product.find_by_name(%{JavaScript and Ajax For Dummies}).id )
Relation.create(:product_id => Product.find_by_name(%{JQuery For Dummies (For Dummies (Computers))}).id, 
			  :assoc_id => Product.find_by_name(%{jQuery Pocket Reference}).id )
Relation.create(:product_id => Product.find_by_name(%{Olympus SZ-10 Digital Camera - Black 3.0 inch LCD}).id, 
			  :assoc_id => Product.find_by_name(%{Olympus TRHLC-120 Traveller Hard Leather Case}).id )
Relation.create(:product_id => Product.find_by_name(%{Olympus SZ-10 Digital Camera - Black 3.0 inch LCD}).id, 
			  :assoc_id => Product.find_by_name(%{Olympus TRHC-120 Traveller Hard Case}).id )
Relation.create(:product_id => Product.find_by_name(%{Olympus SZ-30MR Digital Camera - Silver 3.0 inch LCD}).id, 
			  :assoc_id => Product.find_by_name(%{Olympus TRHLC-120 Traveller Hard Leather Case}).id )
Relation.create(:product_id => Product.find_by_name(%{Olympus SZ-30MR Digital Camera - Silver 3.0 inch LCD}).id, 
			  :assoc_id => Product.find_by_name(%{Olympus TRHC-120 Traveller Hard Case}).id )
Relation.create(:product_id => Product.find_by_name(%{Olympus SZ-30MR Digital Camera - Silver 3.0 inch LCD}).id, 
			  :assoc_id => Product.find_by_name(%{Transcend 16GB SDHC Class 10 Memory Card}).id )
Relation.create(:product_id => Product.find_by_name(%{Canon PowerShot SX220 HS Digital Camera - Grey 3.0}).id, 
			  :assoc_id => Product.find_by_name(%{Lowepro Rezo 30 Digital Camera Pouch - Burnt Orange}).id )
Relation.create(:product_id => Product.find_by_name(%{Panasonic Lumix FS16 Digital Camera - Black 2.7 inch}).id, 
			  :assoc_id => Product.find_by_name(%{Panasonic DMW-PSS13KK Leather Case for FS Series}).id )
Relation.create(:product_id => Product.find_by_name(%{Panasonic Lumix FS16 Digital Camera - Black 2.7 inch}).id, 
			  :assoc_id => Product.find_by_name(%{Panasonic Lumix DMW-PSS13 Genuine Camera Case}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D3100 18-55vr Kit}).id, 
			  :assoc_id => Product.find_by_name(%{Hama Starter Kit for Nikon D3100 Camera}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D3100 18-55vr Kit}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D3100 Digital Field Guide}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D3000 Digital SLR Camera}).id, 
			  :assoc_id => Product.find_by_name(%{Gem Easy Access SLR Camera Case for Nikon D300S, D3000}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D3000 Digital SLR Camera}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D3000 Digital Field Guide}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D5100 Digital SLR Camera}).id, 
			  :assoc_id => Product.find_by_name(%{Gem Easy Access SLR Camera Case for Nikon D5100, D7000}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D5100 Digital SLR Camera}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D5100 Digital Field Guide}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D5100 Digital SLR Camera}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon Li-on batteri EN-EL14, VFB10602}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D7000 Body Only}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon Li-ion battery EN-EL15, VFB10702}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D7000 Body Only}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon 18-200mm F3.5-5.6G IF-ED AF-S VR II DX Lens}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D7000 Body Only}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon AF-S DX 16-85MM}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D7000 Body Only}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon AF-S DX 35mm f1.8G}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D7000 18-105 VR Kit}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon Li-ion battery EN-EL15, VFB10702}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D7000 18-105 VR Kit}).id, 
			  :assoc_id => Product.find_by_name(%{Hoya 67mm Pro-1 Digital UV Screw in Filter}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D7000 18-105 VR Kit}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D7000 Digital Field Guide}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D7000 18-105 VR Kit}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon ML-L3 Remote Control}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D90 Body Only}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon 18-200mm F3.5-5.6G IF-ED AF-S VR II DX Lens}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D90 Body Only}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon 50mm F1.8D AF Nikkor Lens}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D90 Body Only}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon EN-EL3e Rechargeable Battery}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D90 Body Only}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D90 For Dummies}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D90 Body Only}).id, 
			  :assoc_id => Product.find_by_name(%{The Nikon D90 Companion}).id )
Relation.create(:product_id => Product.find_by_name(%{Humax Freeview playback Digital TV Recorder PVR-9150T}).id, 
			  :assoc_id => Product.find_by_name(%{Strand Gold Plated Scart to Scart Lead 1.5m}).id )
Relation.create(:product_id => Product.find_by_name(%{Humax Freeview playback Digital TV Recorder PVR-9150T}).id, 
			  :assoc_id => Product.find_by_name(%{Humax PVR9300T 320GB Twin Tuner, PVR}).id )
Relation.create(:product_id => Product.find_by_name(%{My Book Essential WDBAAF0020HBK - Hard drive - 2 TB - external - Hi-Speed USB}).id, 
			  :assoc_id => Product.find_by_name(%{Western Digital TV Live HD Media Player}).id )
Relation.create(:product_id => Product.find_by_name(%{My Book Essential WDBAAF0020HBK - Hard drive - 2 TB - external - Hi-Speed USB}).id, 
			  :assoc_id => Product.find_by_name(%{DVD Minus (16X speed) Inkjet printable spindle 50}).id )
Relation.create(:product_id => Product.find_by_name(%{Lenovo G570 15.6 inch Notebook (Core i5-2410M, RAM 6GB, HDD 640GB, DVDRW, Windows 7 Home
      Premium) - Black}).id, 
			  :assoc_id => Product.find_by_name(%{Microsoft Office 2010 Home and Student, 3 Users (PC)}).id )
Relation.create(:product_id => Product.find_by_name(%{New Apple Macbook Pro 13 inch Notebook (Intel Core i5 Dual Core 2.3GHz, 4GB RAM, 320GB
      HDD, Up to 7 hrs battery life) - Launched February 2011}).id, 
			  :assoc_id => Product.find_by_name(%{13.3" Inch Apple Macbook Soft Carry Case Sleeve - Black}).id )
Relation.create(:product_id => Product.find_by_name(%{New Apple Macbook Pro 13 inch Notebook (Intel Core i5 Dual Core 2.3GHz, 4GB RAM, 320GB
      HDD, Up to 7 hrs battery life) - Launched February 2011}).id, 
			  :assoc_id => Product.find_by_name(%{LArobe Black Addict MacBook 13.3 Inch - Black + Wasabi}).id )
Relation.create(:product_id => Product.find_by_name(%{Network Fundamentals, CCNA Exploration Companion Guide Cisco Networking Academy
      Program}).id, 
			  :assoc_id => Product.find_by_name(%{Modern Systems Analysis and Design}).id )
Relation.create(:product_id => Product.find_by_name(%{Network Fundamentals, CCNA Exploration Companion Guide Cisco Networking Academy
      Program}).id, 
			  :assoc_id => Product.find_by_name(%{Computer Science Illuminated}).id )
Relation.create(:product_id => Product.find_by_name(%{The Pragmatic Programmer}).id, 
			  :assoc_id => Product.find_by_name(%{Programming Pearls (ACM Press)}).id )
Relation.create(:product_id => Product.find_by_name(%{Peopleware}).id, 
			  :assoc_id => Product.find_by_name(%{The Pragmatic Programmer}).id )
Relation.create(:product_id => Product.find_by_name(%{Code Complete}).id, 
			  :assoc_id => Product.find_by_name(%{The Pragmatic Programmer}).id )
Relation.create(:product_id => Product.find_by_name(%{Code Complete}).id, 
			  :assoc_id => Product.find_by_name(%{Head First Design Patterns}).id )
Relation.create(:product_id => Product.find_by_name(%{Introduction to Java Programming, Comprehensive}).id, 
			  :assoc_id => Product.find_by_name(%{A First Course in Database Systems}).id )
Relation.create(:product_id => Product.find_by_name(%{Introduction to Java Programming, Comprehensive}).id, 
			  :assoc_id => Product.find_by_name(%{Head First Java}).id )
Relation.create(:product_id => Product.find_by_name(%{Introduction to Java Programming, Comprehensive}).id, 
			  :assoc_id => Product.find_by_name(%{Java Pocket Guide (Pocket Guides)}).id )
Relation.create(:product_id => Product.find_by_name(%{C Pocket Reference}).id, 
			  :assoc_id => Product.find_by_name(%{C++ Pocket Reference}).id )
Relation.create(:product_id => Product.find_by_name(%{C Pocket Reference}).id, 
			  :assoc_id => Product.find_by_name(%{The C Programming Language (2nd Edition)}).id )
Relation.create(:product_id => Product.find_by_name(%{C Pocket Reference}).id, 
...
Relation.create(:product_id => Product.find_by_name(%{C Pocket Reference}).id, 
			  :assoc_id => Product.find_by_name(%{Absolute Beginner's Guide to C (Other Sams)}).id )
Relation.create(:product_id => Product.find_by_name(%{Modern Operating Systems}).id, 
			  :assoc_id => Product.find_by_name(%{The C Programming Language (2nd Edition)}).id )
Relation.create(:product_id => Product.find_by_name(%{Modern Operating Systems}).id, 
			  :assoc_id => Product.find_by_name(%{Operating Systems Design and Implementation}).id )
Relation.create(:product_id => Product.find_by_name(%{Absolute Beginner's Guide to C (Other Sams)}).id, 
			  :assoc_id => Product.find_by_name(%{The C Programming Language (2nd Edition)}).id )
Relation.create(:product_id => Product.find_by_name(%{Absolute Beginner's Guide to C (Other Sams)}).id, 
			  :assoc_id => Product.find_by_name(%{C Pocket Reference}).id )
Relation.create(:product_id => Product.find_by_name(%{Absolute Beginner's Guide to C (Other Sams)}).id, 
			  :assoc_id => Product.find_by_name(%{C Programming in Easy Steps}).id )
Relation.create(:product_id => Product.find_by_name(%{Absolute Beginner's Guide to C (Other Sams)}).id, 
			  :assoc_id => Product.find_by_name(%{C for Dummies}).id )
Relation.create(:product_id => Product.find_by_name(%{C. Answer Book (Prentice Hall Software)}).id, 
			  :assoc_id => Product.find_by_name(%{The C Programming Language (2nd Edition)}).id )
Relation.create(:product_id => Product.find_by_name(%{C. Answer Book (Prentice Hall Software)}).id, 
			  :assoc_id => Product.find_by_name(%{C Pocket Reference}).id )
Relation.create(:product_id => Product.find_by_name(%{C. Answer Book (Prentice Hall Software)}).id, 
			  :assoc_id => Product.find_by_name(%{C. Puzzle Book}).id )
Relation.create(:product_id => Product.find_by_name(%{C. Answer Book (Prentice Hall Software)}).id, 
			  :assoc_id => Product.find_by_name(%{Expert C Programming}).id )
Relation.create(:product_id => Product.find_by_name(%{Computer Organization and Design}).id, 
			  :assoc_id => Product.find_by_name(%{The C Programming Language (2nd Edition)}).id )
Relation.create(:product_id => Product.find_by_name(%{Computer Organization and Design}).id, 
			  :assoc_id => Product.find_by_name(%{Professional Issues in Information Technology}).id )
Relation.create(:product_id => Product.find_by_name(%{Computer Organization and Design}).id, 
			  :assoc_id => Product.find_by_name(%{Systems Analysis and Design with UML}).id )
Relation.create(:product_id => Product.find_by_name(%{Exploring Wonderland}).id, 
			  :assoc_id => Product.find_by_name(%{Computer Science Illuminated}).id )
Relation.create(:product_id => Product.find_by_name(%{Exploring Wonderland}).id, 
			  :assoc_id => Product.find_by_name(%{Studying Programming (Palgrave Study Guides)}).id )
Relation.create(:product_id => Product.find_by_name(%{Java for Everyone}).id, 
			  :assoc_id => Product.find_by_name(%{Computer Science Illuminated}).id )
Relation.create(:product_id => Product.find_by_name(%{Pandora's Box}).id, 
			  :assoc_id => Product.find_by_name(%{Human Computer Interaction}).id )
Relation.create(:product_id => Product.find_by_name(%{Pandora's Box}).id, 
			  :assoc_id => Product.find_by_name(%{Computer Science Illuminated}).id )
Relation.create(:product_id => Product.find_by_name(%{Introduction to Algorithms}).id, 
			  :assoc_id => Product.find_by_name(%{Programming Pearls (ACM Press)}).id )
Relation.create(:product_id => Product.find_by_name(%{Seven Languages in Seven Weeks}).id, 
			  :assoc_id => Product.find_by_name(%{Programming In Scala 2nd Edition}).id )
Relation.create(:product_id => Product.find_by_name(%{Learn You a Haskell for Great Good!}).id, 
			  :assoc_id => Product.find_by_name(%{Real World Haskell}).id )
Relation.create(:product_id => Product.find_by_name(%{Learn You a Haskell for Great Good!}).id, 
			  :assoc_id => Product.find_by_name(%{Programming In Scala 2nd Edition}).id )
Relation.create(:product_id => Product.find_by_name(%{Purely Functional Data Structures}).id, 
			  :assoc_id => Product.find_by_name(%{Real World Haskell}).id )
Relation.create(:product_id => Product.find_by_name(%{Purely Functional Data Structures}).id, 
			  :assoc_id => Product.find_by_name(%{Programming In Scala 2nd Edition}).id )
Relation.create(:product_id => Product.find_by_name(%{Agile Web Development with Rails Pragmatic Programmers}).id, 
			  :assoc_id => Product.find_by_name(%{The Ruby Programming Language}).id )
Relation.create(:product_id => Product.find_by_name(%{Agile Web Development with Rails Pragmatic Programmers}).id, 
			  :assoc_id => Product.find_by_name(%{The Rails 3 Way (Addison-Wesley Professional Ruby)}).id )
Relation.create(:product_id => Product.find_by_name(%{Ruby on Rails 3 Tutorial}).id, 
			  :assoc_id => Product.find_by_name(%{The Rails 3 Way (Addison-Wesley Professional Ruby)}).id )
Relation.create(:product_id => Product.find_by_name(%{Ruby on Rails 3 Tutorial}).id, 
			  :assoc_id => Product.find_by_name(%{The Ruby Programming Language}).id )
Relation.create(:product_id => Product.find_by_name(%{Ruby on Rails 3 Tutorial}).id, 
			  :assoc_id => Product.find_by_name(%{Eloquent Ruby (Addison-Wesley Professional Ruby)}).id )
Relation.create(:product_id => Product.find_by_name(%{Beginning Ruby}).id, 
			  :assoc_id => Product.find_by_name(%{The Ruby Programming Language}).id )
Relation.create(:product_id => Product.find_by_name(%{Beginning Ruby}).id, 
			  :assoc_id => Product.find_by_name(%{The Rails 3 Way (Addison-Wesley Professional Ruby)}).id )
Relation.create(:product_id => Product.find_by_name(%{The Rails 3 Way (Addison-Wesley Professional Ruby)}).id, 
			  :assoc_id => Product.find_by_name(%{Eloquent Ruby (Addison-Wesley Professional Ruby)}).id )
Relation.create(:product_id => Product.find_by_name(%{The RSpec Book}).id, 
			  :assoc_id => Product.find_by_name(%{The Rails 3 Way (Addison-Wesley Professional Ruby)}).id )
Relation.create(:product_id => Product.find_by_name(%{The RSpec Book}).id, 
			  :assoc_id => Product.find_by_name(%{Eloquent Ruby (Addison-Wesley Professional Ruby)}).id )
Relation.create(:product_id => Product.find_by_name(%{Metaprogramming Ruby}).id, 
			  :assoc_id => Product.find_by_name(%{Eloquent Ruby (Addison-Wesley Professional Ruby)}).id )
Relation.create(:product_id => Product.find_by_name(%{Design Patterns in Ruby Addison-Wesley Professional Ruby}).id, 
			  :assoc_id => Product.find_by_name(%{Eloquent Ruby (Addison-Wesley Professional Ruby)}).id )
Relation.create(:product_id => Product.find_by_name(%{Design Patterns in Ruby Addison-Wesley Professional Ruby}).id, 
			  :assoc_id => Product.find_by_name(%{The Rails 3 Way (Addison-Wesley Professional Ruby)}).id )
Relation.create(:product_id => Product.find_by_name(%{JavaScript}).id, 
			  :assoc_id => Product.find_by_name(%{jQuery Pocket Reference}).id )
Relation.create(:product_id => Product.find_by_name(%{JavaScript}).id, 
			  :assoc_id => Product.find_by_name(%{jQuery Cookbook}).id )
Relation.create(:product_id => Product.find_by_name(%{JavaScript}).id, 
			  :assoc_id => Product.find_by_name(%{Introducing HTML 5 (Voices That Matter)}).id )
Relation.create(:product_id => Product.find_by_name(%{Python Essential Reference (4th Edition) eBook}).id, 
			  :assoc_id => Product.find_by_name(%{Real World Haskell}).id )
Relation.create(:product_id => Product.find_by_name(%{HTML5 and CSS3}).id, 
			  :assoc_id => Product.find_by_name(%{jQuery in Action, Second Edition}).id )
Relation.create(:product_id => Product.find_by_name(%{HTML5 and CSS3}).id, 
			  :assoc_id => Product.find_by_name(%{Introducing HTML 5 (Voices That Matter)}).id )
Relation.create(:product_id => Product.find_by_name(%{HTML5 and CSS3}).id, 
			  :assoc_id => Product.find_by_name(%{jQuery Pocket Reference}).id )
Relation.create(:product_id => Product.find_by_name(%{jQuery Cookbook}).id, 
			  :assoc_id => Product.find_by_name(%{jQuery Pocket Reference}).id )
Relation.create(:product_id => Product.find_by_name(%{jQuery Cookbook}).id, 
			  :assoc_id => Product.find_by_name(%{jQuery in Action, Second Edition}).id )
Relation.create(:product_id => Product.find_by_name(%{jQuery Cookbook}).id, 
			  :assoc_id => Product.find_by_name(%{Introducing HTML 5 (Voices That Matter)}).id )
Relation.create(:product_id => Product.find_by_name(%{Introducing HTML 5 (Voices That Matter)}).id, 
			  :assoc_id => Product.find_by_name(%{jQuery in Action, Second Edition}).id )
Relation.create(:product_id => Product.find_by_name(%{Pro ASP.NET MVC 3 Framework 3rd Edition}).id, 
			  :assoc_id => Product.find_by_name(%{jQuery in Action, Second Edition}).id )
Relation.create(:product_id => Product.find_by_name(%{CSS}).id, 
			  :assoc_id => Product.find_by_name(%{Introducing HTML 5 (Voices That Matter)}).id )
Relation.create(:product_id => Product.find_by_name(%{CSS}).id, 
			  :assoc_id => Product.find_by_name(%{jQuery in Action, Second Edition}).id )
Relation.create(:product_id => Product.find_by_name(%{Stunning CSS3}).id, 
			  :assoc_id => Product.find_by_name(%{Introducing HTML 5 (Voices That Matter)}).id )
Relation.create(:product_id => Product.find_by_name(%{JavaScript Pocket Reference Pocket Reference O'Reilly}).id, 
			  :assoc_id => Product.find_by_name(%{jQuery Pocket Reference}).id )
Relation.create(:product_id => Product.find_by_name(%{CSS Pocket Reference}).id, 
			  :assoc_id => Product.find_by_name(%{jQuery Pocket Reference}).id )
Relation.create(:product_id => Product.find_by_name(%{HTML & XHTML Pocket Reference Pocket Reference O'Reilly}).id, 
			  :assoc_id => Product.find_by_name(%{jQuery Pocket Reference}).id )
Relation.create(:product_id => Product.find_by_name(%{CSS Pocket Reference (Pocket Reference (O'Reilly))}).id, 
			  :assoc_id => Product.find_by_name(%{jQuery Pocket Reference}).id )
Relation.create(:product_id => Product.find_by_name(%{JavaScript and Ajax For Dummies}).id, 
			  :assoc_id => Product.find_by_name(%{JQuery For Dummies (For Dummies (Computers))}).id )
Relation.create(:product_id => Product.find_by_name(%{HTML, XHTML and CSS For Dummies For Dummies Computers}).id, 
			  :assoc_id => Product.find_by_name(%{JavaScript and Ajax For Dummies}).id )
Relation.create(:product_id => Product.find_by_name(%{PHP and MySQL Web Development All-in-one Desk Reference For Dummies}).id, 
			  :assoc_id => Product.find_by_name(%{JavaScript and Ajax For Dummies}).id )
Relation.create(:product_id => Product.find_by_name(%{jQuery}).id, 
			  :assoc_id => Product.find_by_name(%{Introducing HTML 5 (Voices That Matter)}).id )
Relation.create(:product_id => Product.find_by_name(%{jQuery}).id, 
			  :assoc_id => Product.find_by_name(%{jQuery Cookbook}).id )
Relation.create(:product_id => Product.find_by_name(%{jQuery}).id, 
...
Relation.create(:product_id => Product.find_by_name(%{jQuery}).id, 
			  :assoc_id => Product.find_by_name(%{jQuery in Action, Second Edition}).id )
Relation.create(:product_id => Product.find_by_name(%{ABC Products Rechargeable Lithium-Ion Battery Li50b}).id, 
			  :assoc_id => Product.find_by_name(%{Olympus TRHLC-120 Traveller Hard Leather Case}).id )
Relation.create(:product_id => Product.find_by_name(%{Ex-Pro Olympus Li-50b, Li50b, High Power Plus+ 925mAh 2}).id, 
			  :assoc_id => Product.find_by_name(%{Olympus TRHLC-120 Traveller Hard Leather Case}).id )
Relation.create(:product_id => Product.find_by_name(%{Ex-Pro Olympus Li-50b, Li50b, High Power Plus+ 925mAh 2}).id, 
			  :assoc_id => Product.find_by_name(%{Olympus TRHC-120 Traveller Hard Case}).id )
Relation.create(:product_id => Product.find_by_name(%{Ex-Pro Olympus Li-50B, Li50b Digital Camera Battery}).id, 
			  :assoc_id => Product.find_by_name(%{Olympus TRHLC-120 Traveller Hard Leather Case}).id )
Relation.create(:product_id => Product.find_by_name(%{Olympus Traveller Accessory Kit 50B for SZ-10}).id, 
			  :assoc_id => Product.find_by_name(%{Transcend 16GB SDHC Class 10 Memory Card}).id )
Relation.create(:product_id => Product.find_by_name(%{Energizer CA5L Digital Camera Battery Equivalent to}).id, 
			  :assoc_id => Product.find_by_name(%{Lowepro Rezo 30 Digital Camera Pouch - Burnt Orange}).id )
Relation.create(:product_id => Product.find_by_name(%{SANDISK 8 GB Secure Digital SDHC Card - Frustration Free Packaging}).id, 
			  :assoc_id => Product.find_by_name(%{Panasonic DMW-PSS13KK Leather Case for FS Series}).id )
Relation.create(:product_id => Product.find_by_name(%{Hama Starter Kit for Nikon D3100 Camera}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D3100 18-55vr Kit}).id )
Relation.create(:product_id => Product.find_by_name(%{Hama Starter Kit for Nikon D3100 Camera}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D3100 Digital Field Guide}).id )
Relation.create(:product_id => Product.find_by_name(%{Hama Starter Kit for Nikon D3100 Camera}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon Li-on batteri EN-EL14, VFB10602}).id )
Relation.create(:product_id => Product.find_by_name(%{AmazonBasics Wireless Remote Control for Nikon P7000}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D3100 18-55vr Kit}).id )
Relation.create(:product_id => Product.find_by_name(%{AmazonBasics Wireless Remote Control for Nikon P7000}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D7000 Body Only}).id )
Relation.create(:product_id => Product.find_by_name(%{AmazonBasics Wireless Remote Control for Nikon P7000}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D90 Body Only}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D3100}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D3100 18-55vr Kit}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D3100}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D3100 Digital Field Guide}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D3100}).id, 
...
Relation.create(:product_id => Product.find_by_name(%{Nikon D3100}).id, 
			  :assoc_id => Product.find_by_name(%{Hama Starter Kit for Nikon D3100 Camera}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D3100 Digital Field Guide}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D3100 18-55vr Kit}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D3100 Digital Field Guide}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon Li-on batteri EN-EL14, VFB10602}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D3100 Digital Field Guide}).id, 
			  :assoc_id => Product.find_by_name(%{Hama Starter Kit for Nikon D3100 Camera}).id )
Relation.create(:product_id => Product.find_by_name(%{Lowepro Nova 160 AW All Weather Shoulder Bag for}).id, 
			  :assoc_id => Product.find_by_name(%{Transcend 16GB SDHC Class 10 Memory Card}).id )
Relation.create(:product_id => Product.find_by_name(%{Lowepro Nova 160 AW All Weather Shoulder Bag for}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D3100 18-55vr Kit}).id )
Relation.create(:product_id => Product.find_by_name(%{SquareTrade 3-Year Warranty Plus Accident Protection}).id, 
			  :assoc_id => Product.find_by_name(%{Panasonic DMW-PSS13KK Leather Case for FS Series}).id )
Relation.create(:product_id => Product.find_by_name(%{Gem Easy Access SLR Camera Case for Nikon D300S, D3000}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D3000 Digital Field Guide}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D3000 For Dummies For Dummies Lifestyles Paperback}).id, 
			  :assoc_id => Product.find_by_name(%{Gem Easy Access SLR Camera Case for Nikon D300S, D3000}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D3000 For Dummies For Dummies Lifestyles Paperback}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D3000 Digital Field Guide}).id )
Relation.create(:product_id => Product.find_by_name(%{Lig0sh}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D90 Body Only}).id )
Relation.create(:product_id => Product.find_by_name(%{Lig0sh}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon ML-L3 Remote Control}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D3000}).id, 
			  :assoc_id => Product.find_by_name(%{Gem Easy Access SLR Camera Case for Nikon D300S, D3000}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D3000}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D3000 Digital Field Guide}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D3000 Digital Field Guide}).id, 
			  :assoc_id => Product.find_by_name(%{Gem Easy Access SLR Camera Case for Nikon D300S, D3000}).id )
Relation.create(:product_id => Product.find_by_name(%{Gem Easy Access SLR Camera Case for Nikon D5100, D7000}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon Li-on batteri EN-EL14, VFB10602}).id )
Relation.create(:product_id => Product.find_by_name(%{Gem Easy Access SLR Camera Case for Nikon D5100, D7000}).id, 
			  :assoc_id => Product.find_by_name(%{Transcend 16GB SDHC Class 10 Memory Card}).id )
Relation.create(:product_id => Product.find_by_name(%{Gem Easy Access SLR Camera Case for Nikon D5100, D7000}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D5100 Digital Field Guide}).id )
Relation.create(:product_id => Product.find_by_name(%{Gem Easy Access SLR Camera Case for Nikon D5100, D7000}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D7000 18-105 VR Kit}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D5100 For Dummies (For Dummies (Computers))}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D5100 Digital Field Guide}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D5100 For Dummies (For Dummies (Computers))}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon Li-on batteri EN-EL14, VFB10602}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D5100 Digital Field Guide}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon Li-on batteri EN-EL14, VFB10602}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D5100 Digital Field Guide}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon ML-L3 Remote Control}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon AF-S DX NIKKOR 55-300mm f/4.5-5.6G VR Lens}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon Li-on batteri EN-EL14, VFB10602}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon AF-S DX NIKKOR 55-300mm f/4.5-5.6G VR Lens}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D3100 18-55vr Kit}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon Li-on batteri EN-EL14, VFB10602}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D3100 18-55vr Kit}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon Li-ion battery EN-EL15, VFB10702}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D7000 Body Only}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon Li-ion battery EN-EL15, VFB10702}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon ML-L3 Remote Control}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon Li-ion battery EN-EL15, VFB10702}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D7000 Digital Field Guide}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon 18-200mm F3.5-5.6G IF-ED AF-S VR II DX Lens}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D7000 Body Only}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon 18-200mm F3.5-5.6G IF-ED AF-S VR II DX Lens}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D90 Body Only}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon 18-200mm F3.5-5.6G IF-ED AF-S VR II DX Lens}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon Li-ion battery EN-EL15, VFB10702}).id )
Relation.create(:product_id => Product.find_by_name(%{Neewer Vertical Battery Grip for Nikon D7000 Digital}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon Li-ion battery EN-EL15, VFB10702}).id )
Relation.create(:product_id => Product.find_by_name(%{Neewer Vertical Battery Grip for Nikon D7000 Digital}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D7000 Body Only}).id )
Relation.create(:product_id => Product.find_by_name(%{Neewer Vertical Battery Grip for Nikon D7000 Digital}).id, 
...
Relation.create(:product_id => Product.find_by_name(%{Neewer Vertical Battery Grip for Nikon D7000 Digital}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D7000 18-105 VR Kit}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon AF-S DX 16-85MM}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D7000 Body Only}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon AF-S DX 16-85MM}).id, 
			  :assoc_id => Product.find_by_name(%{Hoya 67mm Pro-1 Digital UV Screw in Filter}).id )
Relation.create(:product_id => Product.find_by_name(%{David Busch's Nikon D7000 Guide to Digital SLR Photography}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon Li-ion battery EN-EL15, VFB10702}).id )
Relation.create(:product_id => Product.find_by_name(%{David Busch's Nikon D7000 Guide to Digital SLR Photography}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D7000 Body Only}).id )
Relation.create(:product_id => Product.find_by_name(%{David Busch's Nikon D7000 Guide to Digital SLR Photography}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D7000 Digital Field Guide}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon AF-S DX 35mm f1.8G}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D7000 Body Only}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon AF-S DX 35mm f1.8G}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon ML-L3 Remote Control}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D7000 For Dummies For Dummies Lifestyles Paperback}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D7000 Digital Field Guide}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D7000 For Dummies For Dummies Lifestyles Paperback}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D7000 18-105 VR Kit}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D7000 For Dummies For Dummies Lifestyles Paperback}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon Li-ion battery EN-EL15, VFB10702}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D7000 Digital Field Guide}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon Li-ion battery EN-EL15, VFB10702}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D7000 Digital Field Guide}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D7000 18-105 VR Kit}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon ML-L3 Remote Control}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon Li-ion battery EN-EL15, VFB10702}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon ML-L3 Remote Control}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D5100 Digital Field Guide}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon 50mm F1.8D AF Nikkor Lens}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D90 Body Only}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon EN-EL3e Rechargeable Battery}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon ML-L3 Remote Control}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D90 For Dummies}).id, 
			  :assoc_id => Product.find_by_name(%{The Nikon D90 Companion}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D90 For Dummies}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D90 Body Only}).id )
Relation.create(:product_id => Product.find_by_name(%{Nikon D90 For Dummies}).id, 
...
Relation.create(:product_id => Product.find_by_name(%{Nikon D90 For Dummies}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon ML-L3 Remote Control}).id )
Relation.create(:product_id => Product.find_by_name(%{The Nikon D90 Companion}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D90 For Dummies}).id )
Relation.create(:product_id => Product.find_by_name(%{The Nikon D90 Companion}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon D90 Body Only}).id )
Relation.create(:product_id => Product.find_by_name(%{The Nikon D90 Companion}).id, 
			  :assoc_id => Product.find_by_name(%{Nikon ML-L3 Remote Control}).id )
Relation.create(:product_id => Product.find_by_name(%{WD My Book Live Personal Cloud Storage 2 TB Network Attached Storage}).id, 
			  :assoc_id => Product.find_by_name(%{Western Digital TV Live HD Media Player}).id )
Relation.create(:product_id => Product.find_by_name(%{Belkin F8N204EA Providence Street Case for Notebooks Up to 15.6 inch - Black}).id, 
			  :assoc_id => Product.find_by_name(%{Microsoft Office 2010 Home and Student, 3 Users (PC)}).id )
Relation.create(:product_id => Product.find_by_name(%{Office for Mac 2011, Home and Student Edition (1 User, 1Mac)}).id, 
			  :assoc_id => Product.find_by_name(%{13.3" Inch Apple Macbook Soft Carry Case Sleeve - Black}).id )
Relation.create(:product_id => Product.find_by_name(%{SquareTrade 3-Year Laptop Warranty Plus Accident Protection (900-1000 Items)}).id, 
			  :assoc_id => Product.find_by_name(%{LArobe Black Addict MacBook 13.3 Inch - Black + Wasabi}).id )
Relation.create(:product_id => Product.find_by_name(%{SquareTrade 3-Year Laptop Warranty Plus Accident Protection (900-1000 Items)}).id, 
			  :assoc_id => Product.find_by_name(%{13.3" Inch Apple Macbook Soft Carry Case Sleeve - Black}).id )
Relation.create(:product_id => Product.find_by_name(%{AppleCare Protection Plan for 13 inch MacBook/MacBook Air/MacBook Pro}).id, 
			  :assoc_id => Product.find_by_name(%{LArobe Black Addict MacBook 13.3 Inch - Black + Wasabi}).id )
Relation.create(:product_id => Product.find_by_name(%{Network Fundamentals, CCNA Exploration Labs and Study Guide Cisco Networking Academy
      Program}).id, 
			  :assoc_id => Product.find_by_name(%{Computer Science Illuminated}).id )
Relation.create(:product_id => Product.find_by_name(%{Clean Code}).id, 
			  :assoc_id => Product.find_by_name(%{The Pragmatic Programmer}).id )
Relation.create(:product_id => Product.find_by_name(%{Refactoring}).id, 
			  :assoc_id => Product.find_by_name(%{The Pragmatic Programmer}).id )
Relation.create(:product_id => Product.find_by_name(%{Programming Pearls (ACM Press)}).id, 
			  :assoc_id => Product.find_by_name(%{Introduction to Algorithms}).id )
Relation.create(:product_id => Product.find_by_name(%{Programming Pearls (ACM Press)}).id, 
			  :assoc_id => Product.find_by_name(%{The Pragmatic Programmer}).id )
Relation.create(:product_id => Product.find_by_name(%{Design patterns }).id, 
			  :assoc_id => Product.find_by_name(%{The Pragmatic Programmer}).id )
Relation.create(:product_id => Product.find_by_name(%{Design patterns }).id, 
			  :assoc_id => Product.find_by_name(%{Head First Design Patterns}).id )
Relation.create(:product_id => Product.find_by_name(%{Slack }).id, 
			  :assoc_id => Product.find_by_name(%{The Pragmatic Programmer}).id )
Relation.create(:product_id => Product.find_by_name(%{Head First Design Patterns}).id, 
			  :assoc_id => Product.find_by_name(%{Head First Java}).id )
Relation.create(:product_id => Product.find_by_name(%{Java How to Program}).id, 
			  :assoc_id => Product.find_by_name(%{Java Pocket Guide (Pocket Guides)}).id )
Relation.create(:product_id => Product.find_by_name(%{Java How to Program}).id, 
			  :assoc_id => Product.find_by_name(%{Head First Java}).id )
Relation.create(:product_id => Product.find_by_name(%{UML Distilled}).id, 
			  :assoc_id => Product.find_by_name(%{Java for Everyone}).id )
Relation.create(:product_id => Product.find_by_name(%{Head First Java}).id, 
			  :assoc_id => Product.find_by_name(%{Head First Design Patterns}).id )
Relation.create(:product_id => Product.find_by_name(%{Head First Java}).id, 
			  :assoc_id => Product.find_by_name(%{Java Pocket Guide (Pocket Guides)}).id )
Relation.create(:product_id => Product.find_by_name(%{Java Pocket Guide (Pocket Guides)}).id, 
			  :assoc_id => Product.find_by_name(%{C++ Pocket Reference}).id )
Relation.create(:product_id => Product.find_by_name(%{Java Pocket Guide (Pocket Guides)}).id, 
			  :assoc_id => Product.find_by_name(%{C Pocket Reference}).id )
Relation.create(:product_id => Product.find_by_name(%{Java Pocket Guide (Pocket Guides)}).id, 
...
Relation.create(:product_id => Product.find_by_name(%{C++ Pocket Reference}).id, 
			  :assoc_id => Product.find_by_name(%{Java Pocket Guide (Pocket Guides)}).id )
Relation.create(:product_id => Product.find_by_name(%{Python Pocket Reference Pocket Reference O'Reilly}).id, 
			  :assoc_id => Product.find_by_name(%{C++ Pocket Reference}).id )
Relation.create(:product_id => Product.find_by_name(%{bash Pocket Reference Pocket Reference O'Reilly}).id, 
			  :assoc_id => Product.find_by_name(%{C Pocket Reference}).id )
Relation.create(:product_id => Product.find_by_name(%{Artificial Intelligence}).id, 
			  :assoc_id => Product.find_by_name(%{Introduction to Algorithms}).id )
Relation.create(:product_id => Product.find_by_name(%{Operating Systems Design and Implementation}).id, 
			  :assoc_id => Product.find_by_name(%{The C Programming Language (2nd Edition)}).id )
Relation.create(:product_id => Product.find_by_name(%{Operating Systems Design and Implementation}).id, 
			  :assoc_id => Product.find_by_name(%{Introduction to Algorithms}).id )
Relation.create(:product_id => Product.find_by_name(%{Concepts, Techniques, and Models of Computer Programming}).id, 
			  :assoc_id => Product.find_by_name(%{The Pragmatic Programmer}).id )
Relation.create(:product_id => Product.find_by_name(%{Computer Networks}).id, 
			  :assoc_id => Product.find_by_name(%{Introduction to Algorithms}).id )
Relation.create(:product_id => Product.find_by_name(%{C++}).id, 
			  :assoc_id => Product.find_by_name(%{C++ Pocket Reference}).id )
Relation.create(:product_id => Product.find_by_name(%{C Programming in Easy Steps}).id, 
			  :assoc_id => Product.find_by_name(%{C for Dummies}).id )
Relation.create(:product_id => Product.find_by_name(%{C for Dummies}).id, 
			  :assoc_id => Product.find_by_name(%{The C Programming Language (2nd Edition)}).id )
Relation.create(:product_id => Product.find_by_name(%{C for Dummies}).id, 
			  :assoc_id => Product.find_by_name(%{C Programming in Easy Steps}).id )
Relation.create(:product_id => Product.find_by_name(%{C for Dummies}).id, 
			  :assoc_id => Product.find_by_name(%{Absolute Beginner's Guide to C (Other Sams)}).id )
Relation.create(:product_id => Product.find_by_name(%{C. Puzzle Book}).id, 
			  :assoc_id => Product.find_by_name(%{The C Programming Language (2nd Edition)}).id )
Relation.create(:product_id => Product.find_by_name(%{C. Puzzle Book}).id, 
			  :assoc_id => Product.find_by_name(%{C. Answer Book (Prentice Hall Software)}).id )
Relation.create(:product_id => Product.find_by_name(%{C. Puzzle Book}).id, 
...
Relation.create(:product_id => Product.find_by_name(%{C. Puzzle Book}).id, 
			  :assoc_id => Product.find_by_name(%{Expert C Programming}).id )
Relation.create(:product_id => Product.find_by_name(%{C Programming}).id, 
			  :assoc_id => Product.find_by_name(%{The C Programming Language (2nd Edition)}).id )
Relation.create(:product_id => Product.find_by_name(%{C Programming}).id, 
			  :assoc_id => Product.find_by_name(%{C Pocket Reference}).id )
Relation.create(:product_id => Product.find_by_name(%{Expert C Programming}).id, 
			  :assoc_id => Product.find_by_name(%{The C Programming Language (2nd Edition)}).id )
Relation.create(:product_id => Product.find_by_name(%{Expert C Programming}).id, 
			  :assoc_id => Product.find_by_name(%{C Pocket Reference}).id )
Relation.create(:product_id => Product.find_by_name(%{Advanced Programming in the UNIX Environment Addison-Wesley Professional Computing}).id, 
			  :assoc_id => Product.find_by_name(%{The C Programming Language (2nd Edition)}).id )
Relation.create(:product_id => Product.find_by_name(%{Computer Architecture}).id, 
			  :assoc_id => Product.find_by_name(%{Introduction to Algorithms}).id )
Relation.create(:product_id => Product.find_by_name(%{Systems Analysis and Design with UML}).id, 
			  :assoc_id => Product.find_by_name(%{Java for Everyone}).id )
Relation.create(:product_id => Product.find_by_name(%{Learning to Program with Alice (w/CD-ROM)}).id, 
			  :assoc_id => Product.find_by_name(%{Computer Science Illuminated}).id )
Relation.create(:product_id => Product.find_by_name(%{The Essentials of Computer Organization and Architecture}).id, 
			  :assoc_id => Product.find_by_name(%{Java for Everyone}).id )
Relation.create(:product_id => Product.find_by_name(%{Discrete Mathematics and Its Applications with MathZone}).id, 
			  :assoc_id => Product.find_by_name(%{Java for Everyone}).id )
Relation.create(:product_id => Product.find_by_name(%{Discrete Mathematics and Its Applications with MathZone}).id, 
			  :assoc_id => Product.find_by_name(%{C Programming in Easy Steps}).id )
Relation.create(:product_id => Product.find_by_name(%{Object-Oriented Analysis and Design}).id, 
			  :assoc_id => Product.find_by_name(%{Java for Everyone}).id )
Relation.create(:product_id => Product.find_by_name(%{Human Computer Interaction}).id, 
			  :assoc_id => Product.find_by_name(%{The C Programming Language (2nd Edition)}).id )
Relation.create(:product_id => Product.find_by_name(%{Applying UML and Patterns}).id, 
			  :assoc_id => Product.find_by_name(%{Head First Design Patterns}).id )
